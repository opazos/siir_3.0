...
<head>
  ...
  <link rel="stylesheet" href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.20/themes/base/jquery-ui.css">
...
<body>
  ...
  <div class="row">
    <div class="twelve columns">
      ...
      <p>This is version <strong>3.0.9</strong> generated on August 24, 2012.</p>
      <hr />
    </div>
  </div>
  ...
  <div class="row">
    <div class="eight columns">
      ...
      <div class="row">
        <div class="twelve columns">
          <h3>jQuery UI Datepicker</h3>
          <form>
            <input type="text" class="four date">
          </form>
        </div>
      </div>
