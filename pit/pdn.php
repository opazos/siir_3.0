...
ORDER BY pit_bd_ficha_pdn.f_presentacion ASC";	
		}
		else
		{
			$sql="SELECT pit_bd_ficha_pdn.cod_pdn, 
...
$num++
			?>        
			        <tr>
				        ...
				        {
				        ?>
				        <a href="../print/print_ficha_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_pdn'];?>" class="small success button">Imprimir</a>
				        <?
				        }
				        elseif($modo==edit)
				        {
				        ...
				        {
				        ?>
				        <a href="gestor_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_pdn'];?>&action=DELETE" class="small alert button">Borrar</a>
				        <?
				        }
				        elseif($modo==imprime_familia)
				        {
				        ?>
				        <a href="../print/familia_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $fila['cod_pdn'];?>" class="small success button">Imprimir</a>
				        <?
				        }
				        ?>
				        </td>
