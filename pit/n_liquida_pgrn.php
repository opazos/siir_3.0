...
<form name="form5" method="post" class="custom" action="gestor_liquida_pgrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
...
<div class="row">
  ...
  <div class="ten columns">
    ...
    pit_bd_ficha_mrn.cod_estado_iniciativa<>004 AND
    pit_bd_ficha_mrn.cod_estado_iniciativa<>006 AND
  ...
  <div class="four columns"><input type="date" name="f_liquidacion" placeholder="aaaa-mm-dd" maxlength="10" class="required date seven" value="<? echo $fecha_hoy;?>"></div>
  ...
  <div class="twelve columns"><textarea name="observaciones" rows="5"  style="width: 100%"></textarea></div>
</div>
