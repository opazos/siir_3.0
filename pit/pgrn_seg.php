...
<hr>
	...
	pit_bd_ficha_mrn.f_presentacion_2 AS f_presentacion, 
	sys_bd_estado_iniciativa.descripcion AS estado, 
	org_ficha_organizacion.n_documento, 
	org_ficha_organizacion.nombre, 
	pit_bd_mrn_sd.cod_ficha_sd
FROM sys_bd_estado_iniciativa INNER JOIN pit_bd_ficha_mrn ON sys_bd_estado_iniciativa.cod_estado_iniciativa = pit_bd_ficha_mrn.cod_estado_iniciativa
	 INNER JOIN pit_bd_mrn_sd ON pit_bd_mrn_sd.cod_mrn = pit_bd_ficha_mrn.cod_mrn
...
WHERE pit_bd_ficha_mrn.cod_estado_iniciativa='006'
...
ORDER BY f_presentacion ASC";
			      ...
			      ?>  
			        <tr>
				        ...
				        {
				        ?>
				        <a href="m_pgrn_seg.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_ficha_sd'];?>" class="small primary button">Editar</a>
				        <?
				        }
				        elseif($modo==delete)
				        {
				        ?>
				        <a href="" class="small alert button">Cancelar</a>
				        <?
				        }
				        elseif($modo==imprime_familia)
				        {
				        ?>
				        <a href="../print/familia_mrn_seg.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $fila['cod_mrn'];?>" class="small success button">Imprimir</a>
				        <?
				        }
				        ?>
				        </td>
