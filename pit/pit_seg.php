...
$sql="SELECT pit_bd_ficha_pit.cod_pit, 
	...
	pit_bd_ficha_pit.f_presentacion_2 AS f_presentacion, 
	...
	FROM org_ficha_taz INNER JOIN pit_bd_ficha_pit ON org_ficha_taz.cod_tipo_doc = pit_bd_ficha_pit.cod_tipo_doc_taz AND org_ficha_taz.n_documento = pit_bd_ficha_pit.n_documento_taz
	 ...
	 WHERE pit_bd_ficha_pit.cod_estado_iniciativa=006 
	 ORDER BY pit_bd_ficha_pit.f_presentacion_2 ASC";
}
else
{
$sql="SELECT pit_bd_ficha_pit.cod_pit, 
...
?>			        
			        <tr>
				        ...
				        {
				        ?>
				        <a href="" class="small success button">Imprimir</a></td>
				        <?
				        }
				        elseif($modo==edit)
				        {
				        ?>
				        <a href="m_pit_seg.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_pit'];?>" class="small primary button">Editar</a>
				        <?
				        }
				        elseif($modo==delete)
				        {
				        ?>
				        <a href="" class="small alert button">Quitar</a>
				        <?
				        }
				        ?>
			        </tr>
