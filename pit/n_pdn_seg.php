...
<form name="form5" method="post" action="gestor_pdn_seg.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
	...
	<div class="four columns"><input type="text" name="monto_org" class="required seven number"></div>
	...
	<div class="four columns"><input type="text" name="n_cheque" class="required seven"></div>
