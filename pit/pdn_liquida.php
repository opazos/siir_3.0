	        ...
	        ?>
		        <tr>
			        ...
			        <td>
				        ...
				        {
				        ?>
				        <a href="m_liquida_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_ficha_liquida'];?>" class="small primary button">Editar</a>
				        <?
				        }
				        elseif($modo==imprime)
				        {
				        ?>
				        <a href="../print/print_ficha_pdn_liquida.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $fila['cod_pdn'];?>" class="small success button">Imprimir</a>
				        <?
				        }
				        ?>
			        </td>
