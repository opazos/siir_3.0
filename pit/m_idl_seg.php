...
<form name="form5" method="post" action="gestor_idl_seg.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&action=UPDATE" onsubmit="return checkSubmit();">
	...
	<div class="four columns"><input type="date" name="f_presentacion" class="seven required date" placeholder="aaaa-mm-dd" maxlength="10"  value="<? echo $row1['f_desembolso'];?>"></div>
	...
	<div class="twelve columns">
		<textarea name="comentario" rows="5"><? echo $row['just_plazo'];?></textarea>
	</div>
	<div class="twelve columns"><br/></div>
