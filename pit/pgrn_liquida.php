    ...
    <div class="nine columns">
      <div class="panel">
        ...
        <table class="responsive" id="lista">
	        ...
	        <?
	        $num=0;
	        $sql="SELECT pit_bd_mrn_liquida.cod_ficha_liquida, 
	        ...
	        ?>
	        	<tr>
		        	...
		        	<td>
			        	...
			        	{
			        	?>
			        	<a href="m_liquida_pgrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_ficha_liquida'];?>" class="small primary button">Editar</a>
			        	<?
			        	}
			        	elseif($modo==imprime)
			        	{
			        	?>
			        	<a href="../print/print_pgrn_liquida.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $fila['cod_mrn'];?>" class="small success button">Imprime</a>
			        	<?
			        	}
			        	?>
		        	</td>
