...
<form name="form5" method="post" action="gestor_idl_seg.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD_LIQUIDA" onsubmit="return checkSubmit();">
	...
	<div class="twelve columns">
		<select name="idl" class="hyjack">
			...
			pit_bd_ficha_idl.cod_estado_iniciativa<>'002' AND
			pit_bd_ficha_idl.cod_estado_iniciativa<>'003' AND
			pit_bd_ficha_idl.cod_estado_iniciativa<>'004' AND
	...
	<div class="two columns">Fecha de deposito de Desembolso</div>
	...
	<div class="twelve columns">
		<textarea name="comentario1" rows="5"></textarea>
	</div>
	...
	<div class="twelve columns">
		...
		<a href="idl_liquida.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime" class="secondary button">Cancelar</a>
	</div>
