...
<!-- Contenedores -->
<dl class="tabs">
<dd  class="active"><a href="">Realizar Addenda a Convenio Marco</a></dd>
</dl>
<!-- Termino contenedores -->
<ul class="tabs-content">
<li class="active" id="simple1Tab">
<div class="row collapse">
<form name="form5" method="post" class="custom" action="gestor_adenda_convenio.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
<div class="two columns">Fecha de firma de la addenda</div>
<div class="four columns"><input name="f_adenda" type="date" class="required date seven" placeholder="aaaa-mm-dd" maxlength="10"></div>
...
<div class="twelve columns">
  ...
  {
  ?>
  <option value="<? echo $f1['cod_ficha'];?>"><? echo numeracion($f1['n_convenio'])."-".periodo($f1['f_presentacion']);?></option>
  <?
  }
  ?>
  </select>
