...
?>      
        <form name="form5" class="custom" method="post" action="gestor_contrato_pit_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
	        ...
	        <div class="twelve columns">
		        <select name="pit">
			        ...
			        WHERE pit_bd_ficha_pit.cod_estado_iniciativa=002 AND
		    ...
		    <div class="twelve columns">
			    <select name="poa">
				    ...
				    {
				    ?>
				    <option value="<? echo $r3['cod'];?>" <? if ($r3['codigo']=='3.1.2.7.') echo "selected";?>><? echo $r3['codigo']."-".$r3['nombre'];?></option>
				    <?
				    }
				    ?>
			    </select>
	        ...
	        <a href="contrato_pit_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime" class="primary button">Cancelar</a>
	        </div>
        </form>
...
?>		
		<tr>
			...
			<td><a href="gestor_contrato_pit_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&id=<? echo $f2['cod_atf_pdn'];?>&action=UPDATE_PDN" class="small success button">Actualizar</a></td>
		</tr>
<?
}
?>		
...
?>		
		<tr>
			...
			<td><? echo $f2['nombre'];?></td>
			<td><? echo $f2['lema'];?></td>
			<td><a href="gestor_contrato_pit_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $f2['cod_atf_mrn'];?>&cod=<? echo $cod;?>&action=UPDATE_MRN" class="small success button">Actualizar</a></td>
		</tr>
<?
}
?>		
