...
<?
	if ($modo==rutero)
	{
		echo "2.- Persona que participara de la ruta";
	}
	else
	{
		echo "1.- Datos de la ruta de aprendizaje";
	}
?>
</a></dd>
</dl>
...
{
?>
<form name="form5" class="custom" method="post" action="gestor_contrato_ruta.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&action=ADD_RUTERO" onsubmit="return checkSubmit();">
<div class="twelve columns">Seleccione a la persona que participara de la ruta de aprendizaje</div>
<div class="twelve columns">
	<select name="rutero">
...
<div class="twelve columns">
	<button type="submit" class="success button" id="btn_envia">Guardar cambios e imprimir contrato</button>
</div>
...
{
?>
<form name="form5" method="post" class="custom" action="gestor_contrato_ruta.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
	...
	<div class="twelve columns"><input type="text" name="evento" class="required"></div>

	<div class="two columns">Tipo de actividad</div>
	<div class="four columns">
		<select name="tipo_ruta" required="required">
			<option value="" selected="selected">Seleccionar</option>
			<option value="1">Encuentro del conocimiento</option>
			<option value="2">Capacitación del personal</option>
			<option value="3">Capacitación de talentos locales</option>
			<option value="4">Capacitación de oferentes técnicos</option>
			<option value="5">Diplomado</option>
			<option value="6">Otros</option>
		</select>
	</div>
	<div class="two columns">Especificar (Si eligio otro)</div>
	<div class="four columns"><input type="text" name="otro" class="nine"></div>
	...
	<div class="twelve columns"><textarea name="objetivo"></textarea></div>
	...
	<div class="four columns"><input type="text" name="n_contrato" class="required digits seven" readonly="readonly" value="<? echo $n_contrato;?>">
	...
	<div class="four columns"><input type="text" name="aporte_pdss" class="required number seven"></div>
	<div class="two columns">Aporte Organización (S/.)</div>
	<div class="four columns"><input type="text" name="aporte_org" class="required number seven "></div>	
	<div class="two columns">Aporte Otros (S/.)</div>
	<div class="four columns"><input type="text" name="aporte_otro" class="required number seven"></div>
	...
	<div class="four columns"><input type="text" name="n_cuenta" class="required  ten"></div>
	...
	<div class="four columns">
		<select name="ifi" class="large">
			...
			{
				echo "<option value='".$r2['cod_ifi']."'>".$r2['descripcion']."</option>";
			}
			?>
		</select>
	</div>
	...
	<div class="twelve columns">
		...
		<a href="contrato_ruta.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime" class="secondary button">Cancelar operacion</a>
	</div>
