...
<form name="form5" class="custom" method="post" action="gestor_contrato_idl.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
	...
	<div class="twelve columns">
		<select name="org">
			...
			WHERE pit_bd_ficha_idl.cod_estado_iniciativa=002 AND
	...
	<div class="four columns"><input type="text" name="n_contrato" class="required digits five" readonly="readonly" value="<? echo $n_contrato;?>">
	...
	<div class="four columns"><input type="text" name="fida" class="required number five" value="50"></div>
	<div class="two columns">Financiamiento RO</div>
	<div class="four columns"><input type="text" name="ro" class="required number five" value="50"></div>	
	
	<div class="twelve columns">
		<button type="submit" class="success button" id="btn_envia">Guardar cambios</button>
		<a href="contrato_idl.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime" class="primary button">Cancelar</a>
	</div>
