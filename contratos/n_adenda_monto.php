...
<!-- Contenedores -->
<dl class="tabs">
<dd  class="active"><a href="">Registrar nueva addenda de plazo y monto</a></dd>
</dl>
<!-- Termino contenedores -->
<ul class="tabs-content">
<li class="active" id="simple1Tab">
<div class="row collapse">
<form name="form5" class="custom" method="post" action="gestor_adenda_monto.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
	...
	<div class="four columns"><input type="text" name="n_animador" class="required digits five"></div>
	<div class="two columns">Incentivo Mensual(S/.)</div>
	<div class="four columns"><input type="text" name="monto_animador" class="required number five" readonly="readonly" value="210"></div>
	...
	<div class="twelve columns">
		...
		<a href="adenda_monto.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime" class="secondary button">Cancelar</a>
	</div>
