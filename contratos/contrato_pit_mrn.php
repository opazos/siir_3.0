...
<div class="three panel columns">
 <ul class="nav-bar vertical">
  <li class="active"><a href="n_contrato_pit_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=pit">Registrar nuevo contrato</a></li>
  <li><a href="contrato_pit_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime">Imprimir contrato</a></li>
  <li><a href="contrato_pit_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit">Modificacion avanzada</a>
<?
if ($row['cod_tipo_usuario']<>'U')
{
?>   
  <li><a href="contrato_pit_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=anula">Anular contrato</a>  
<?
} 
?> 
  </li>
      ...
      <div class="panel">
        ...
        <div class="twelve columns">
	      ...
	      <? include("../plugins/buscar/buscador.html");?>  
	        <table class="reponsive" id="lista">
		        <thead>
			        <tr>
				        <th>Nº Contrato</th>
				        <th>Nº Documento</th>
...
?>		        
			        <tr>
				        ...
				        {
				        ?>
				        <a href="../print/print_contrato_pit_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $fila['cod_pit'];?>" class="small success button">Imprimir</a>
				        <?
				        }
				        elseif($modo==edit /*and $anio==$anio_actual*/)
				        {
				        ?>
				        <a href="m_contrato_pit_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_pit'];?>&modo=pit" class="small primary button">Editar</a>
				        <?
				        }
				        elseif($modo==anula)
				        {
				        ?>
				        <a href="gestor_contrato_pit_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_pit'];?>&action=ANULA" class="small alert button" onclick="return confirm('Va a anular este contrato, desea proceder ?')">Anular</a>
				        <?
				        }
				        ?>
				        </td>
