...
$sql="SELECT * FROM pit_bd_ficha_adenda WHERE cod_adenda='$id'";
$result=mysql_query($sql) or die (mysql_error());
...
<form name="form5" class="custom" method="post" action="gestor_adenda_plazo.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=UPDATE" onsubmit="return checkSubmit();">
	
	
	<div class="two columns">Fecha de firma</div>
	<div class="ten columns">
	<input type="date" name="f_adenda" class="three date" placeholder="aaaa-mm-dd" maxlength="10" value="<? echo $row['f_adenda'];?>">
	...
	<div class="twelve columns">
		...
		<a href="adenda_plazo.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit" class="secondary button">Cancelar</a>
	</div>
