...
?>
<form name="form5" method="post" class="custom" action="gestor_amplia_pit.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
	...
	<div class="four columns"><input type="date" name="f_ampliacion" class="required date seven" placeholder="aaaa-mm-dd" maxlength="10" value="<? echo $fecha_hoy;?>"></div>
	...
	<div class="four columns"><input type="text" name="fte_fida" class="required number seven"></div>
	<div class="two columns">% Fuente RO</div>
	<div class="four columns"><input type="text" name="fte_ro" class="required number seven"></div>

	<div class="twelve columns"><br/></div>
	<div class="twelve columns">
		<button type="submit" class="success button" id="btn_envia">Guardar cambios</button>
		<a href="contrato_pit_ampliacion.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime" class="primary button">Cancelar</a>
	</div>
</form>
<?
}
...
?>		
		<tr>
			...
			<td><a href="gestor_amplia_pit.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&id=<? echo $f2['cod_atf_pdn'];?>&action=UPDATE_PDN" class="small success button">Actualizar</a></td>
		</tr>
<?
}
?>		
