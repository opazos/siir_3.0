...
<!-- Contenedores -->
<dl class="tabs">
<dd  class="active"><a href="">Nuevo contrato para la participacion en Eventos de gestión del conocimiento</a></dd>
</dl>
<!-- Termino contenedores -->
<ul class="tabs-content">
<li class="active" id="simple1Tab">
<div class="row collapse">
<form name="form5"  method="post" action="gestor_contrato_gc.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();" class="custom">
...
<div class="row">
	...
	<div class="four columns"><input type="text" name="participantes" class="required digits seven"></div>
	...
	<div class="four columns">
		<select name="tipo_evento" class="required medium">
			...
			{
			?>
			<option value="<? echo $f1['cod'];?>"><? echo $f1['descripcion'];?></option>
			<?
			}
			?>
		</select>
...
<div class="row">
	...
	<div class="ten columns">
		<select name="org" class="large required">
			...
			{
			?>
			<option value="<? echo $f2['cod_tipo_doc'].",".$f2['n_documento'];?>"><? echo $f2['nombre'];?></option>
			<?
			}
			?>
		</select>
	...
	<div class="twelve columns"><textarea name="detalle" rows="5"></textarea></div>
	<div class="two columns">Fecha de contrato</div>
	<div class="four columns"><input type="date" name="f_contrato" placeholder="aaaa-mm-dd" maxlength="10" class="date required seven"></div>
