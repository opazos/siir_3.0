...
<form name="form5" class="custom" method="post" action="gestor_adenda_idl.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
	...
	<div class="twelve columns">
		...
		{
		?>
		<option value="<? echo $f1['cod_ficha_idl'];?>"><? echo numeracion($f1['n_contrato'])."-".periodo($f1['f_contrato']);?></option>
		<?
		}
		?>
		</select>
	...
	<div class="twelve columns">
		...
		<a href="adenda_idl.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime" class="secondary button">Cancelar</a>
	</div>
