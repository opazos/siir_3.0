...
<!-- Contenedores -->
<dl class="tabs">
<dd  class="active"><a href="">Registro de Addendas para Plan de Negocio</a></dd>
</dl>
<!-- Termino contenedores -->
<ul class="tabs-content">
<li class="active" id="simple1Tab">
<div class="row collapse">
<form name="form5" class="custom" method="post" action="gestor_adenda_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
	
<div class="two columns">Fecha de firma</div>
<div class="ten columns"><input type="date" name="f_adenda" class="require three date" placeholder="aaaa-mm-dd" maxlength="10"></div>
...
<div class="four columns"><input type="date" name="f_inicio" class="seven date required" placeholder="aaaa-mm-dd" maxlength="10"></div>
<div class="two columns">N. de meses a ampliar</div>
<div class="four columns"><input type="text" name="meses" class="required seven"></div>
