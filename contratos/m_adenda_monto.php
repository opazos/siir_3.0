...
$sql="SELECT pit_bd_ficha_adenda.cod_adenda, 
	...
	pit_adenda_pit.cod_iniciativa, 
	pit_adenda_pit.n_animador, 
	pit_adenda_pit.monto_animador
FROM pit_adenda_pit INNER JOIN pit_bd_ficha_adenda ON pit_adenda_pit.cod_adenda = pit_bd_ficha_adenda.cod_adenda
...
<!-- Contenedores -->
<dl class="tabs">
<dd  class="active"><a href="">Modificar addenda de plazo y monto</a></dd>
</dl>
<!-- Termino contenedores -->
<ul class="tabs-content">
<li class="active" id="simple1Tab">
<div class="row collapse">
<form name="form5" class="custom" method="post" action="gestor_adenda_monto.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=UPDATE" onsubmit="return checkSubmit();">
	...
	<div class="twelve columns">
		...
		{
		?>
		<option value="<? echo $f1['cod_pit'];?>" <? if ($row['cod_pit']==$f1['cod_pit']) echo "selected";?>><? echo numeracion($f1['n_contrato'])."-".periodo($f1['f_contrato']);?></option>
		<?
		}
		?>
		</select>
	...
	<div class="twelve columns"><br/></div>
	<div class="two columns">Fecha de inicio de la addenda</div>
	...
	<div class="twelve columns"><strong>II.- DATOS DE ANIMADORES TERRITORIALES</strong></div>
	<div class="twelve columns"><br/></div>
	<div class="two columns">Nº de Animadores Territoriales</div>
	<div class="four columns"><input type="text" name="n_animador" class="required digits five" value="<? echo $row['n_animador'];?>"></div>
	<div class="two columns">Incentivo Mensual(S/.)</div>
	<div class="four columns"><input type="text" name="monto_animador" class="required number five" readonly="readonly" value="210">
		<input type="hidden" name="codigo_animador" value="<? echo $row['cod_iniciativa'];?>">
	...
	<div class="twelve columns">
		...
		<a href="adenda_monto.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit_avance" class="secondary button">Cancelar</a>
	</div>
