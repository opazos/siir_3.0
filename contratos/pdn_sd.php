...
<div class="three panel columns">
 <ul class="nav-bar vertical">
  <li class="active"><a href="n_pdn_sd.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>">Registrar solicitud y ATF's</a></li>
  <li><a href="pdn_sd.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime">Imprimir solicitud y ATF's</a></li>
  <li><a href="pdn_sd.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit">Modificar solicitud y ATF's</a></li>
</ul>
...
ORDER BY clar_bd_ficha_sd_pdn.f_desembolso ASC, pit_bd_ficha_pdn.n_contrato ASC";	 
 }
 else
 {
 $sql="SELECT clar_bd_ficha_sd_pdn.cod_ficha_sd, 
...
?>
			        <tr>
				        ...
				        {
				        ?>
				        <a href="../print/print_pdn_sd.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $fila['cod_ficha_sd'];?>" class="small success button">Imprimir</a>
				        <?
				        }
				        elseif($modo==edit and $anio==$anio_actual)
				        {
				        ?>
				        <a href="m_pdn_sd.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_ficha_sd'];?>" class="small primary button">Editar</a>
				        <?
				        }
				        ?>
				        </td>
