...
?>       
<form name="form5" class="custom" method="post" action="gestor_contrato_pit_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
	        
	        <div class="two columns">Nº contrato</div>
	        <div class="ten columns"><input type="text" name="n_contrato" class="required two" value="<? echo $n_contrato;?>"><input type="hidden" name="cod_numeracion" value="<? echo $r1['cod'];?>"></div>
	        ...
	        <div class="twelve columns">
		        <select name="pit">
			        ...
			        WHERE pit_bd_ficha_pit.mancomunidad=1 AND
	        ...
	        <div class="four columns"><input type="date" name="f_contrato" class="required date seven" maxlength="10" placeholder="aaaa-mm-dd" value="<? echo $fecha_hoy;?>"></div>
	        <div class="two columns">Duración (en meses)</div>
	        <div class="four columns"><input type="text" name="duracion" class="required digits five"></div>
	        
	        <div class="two columns">Nº solicitud</div>
	        <div class="ten columns"><input type="text" name="n_solicitud" class="required digits two" value="<? echo $n_solicitud;?>"></div>
	        

	        <div class="twelve columns"><h6>Fuente de financiamiento</h6></div>
	        <div class="two columns">FIDA %</div>
	        <div class="four columns"><input type="text" name="fte_fida" class="required number five" value="100"></div>
	        <div class="two columns">Recursos Ordinarios %</div>
	        <div class="four columns"><input type="text" name="fte_ro" class="required number five" value="0"></div>
	        
	        <div class="twelve columns">
	        <button type="submit" class="success button" id="btn_envia">Guardar cambios</button>
	        <a href="contrato_pit_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime" class="primary button">Cancelar</a>
	        </div>
        </form>
<?
 }
 ...
 ?> 
<form name="form5" class="custom" method="post" action="gestor_contrato_pit_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&action=ADD_PDN" onsubmit="return checkSubmit();"> 
...
<div class="twelve columns">
	<button type="submit" class="success button" id="btn_envia">Guardar cambios</button>
	<a href="../print/print_contrato_pit_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>" class="primary button">Imprimir</a>
	<a href="contrato_pit_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime" class="primary button">Terminar</a>
</div>
...
?>		
		<tr>
			...
			<td><? echo $f2['estado'];?></td>
			<td><a href="gestor_contrato_pit_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&id=<? echo $f2['cod_atf_pdn'];?>&action=UPDATE_ATF_PDN" class="small success button">Actualizar</a></td>
		</tr>
<?
}
?>		
