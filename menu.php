...
?>
    ...
    <ul class="right">
        <li class="has-dropdown">
          ...
          <ul class="dropdown">
          <li><a href="territorio.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit">Territorios</a></li>
          <li class="divider"></li>
         ...
         <li class="has-dropdown"><a href="">Iniciativas</a>
           <ul class="dropdown">
             ...
             <li class="divider"></li>
             <li><a href="ahorro.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime">Programa de Ahorro</a></li>          
             <li class="divider"></li>
