...
<div class="panel">
<div class="row">
<form name="form5" class="custom" method="post" action="gestor_calif_danza.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&action=ADD" onsubmit="return checkSubmit();">
...
<table>
	...
	<tbody>
		...
		<tr>
			<td>Despliegue y presentación en el escenario</td>
...
<div class="twelve columns">
	...
	<a href="calif_danza.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=califica" class="secondary button">Finalizar</a>
</div>
...
<table>
	...
	<?
	$num=0;
	$sql="SELECT gcac_ficha_danza.cod_ficha, 
	gcac_ficha_danza.p_total, 
	gcac_participante_concurso.descripcion, 
	org_ficha_organizacion.nombre, 
	gcac_jurado_concurso.nombres, 
	gcac_jurado_concurso.apellidos
FROM gcac_participante_concurso INNER JOIN gcac_ficha_danza ON gcac_participante_concurso.cod_participante = gcac_ficha_danza.cod_participante
	 INNER JOIN gcac_jurado_concurso ON gcac_jurado_concurso.cod_jurado = gcac_ficha_danza.cod_jurado
...
WHERE gcac_participante_concurso.cod_concurso='$cod'";
	...
	?>
		<tr>
			...
			<td><a href="gestor_calif_danza.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&id=<? echo $fila['cod_ficha'];?>&action=DELETE" class="small alert button">Eliminar</a></td>
		</tr>
	<?
	}
	?>	
