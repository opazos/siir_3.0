...
<form name="form5" method="post" action="gestor_calif_pit.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&action=ADD&modo=SEGUNDO_CLAR" onsubmit="return checkSubmit();">
<div class="two columns">Seleccionar PIT</div>
<div class="four columns">
	<select name="iniciativa" class="hyjack">
		<option value="" selected="selected">Seleccionar</option>
		<?
		$sql="SELECT clar_bd_ficha_pit_2.cod_ficha_pit_clar, 
...
<table>
        ...
        <tr>
          <td rowspan="6">Presentación pública en CLAR del PIT</td>
...
<table>
	...
	clar_bd_miembro.paterno, 
	clar_bd_miembro.materno, 
	clar_calif_ficha_pit_clar_2.total_puntaje, 
	clar_calif_ficha_pit_clar_2.cod_ficha_calif_pit
FROM clar_bd_ficha_pit_2 INNER JOIN clar_calif_ficha_pit_clar_2 ON clar_bd_ficha_pit_2.cod_ficha_pit_clar = clar_calif_ficha_pit_clar_2.cod_ficha_pit_clar
	 INNER JOIN pit_bd_ficha_pit ON pit_bd_ficha_pit.cod_pit = clar_bd_ficha_pit_2.cod_pit
	 INNER JOIN org_ficha_taz ON org_ficha_taz.cod_tipo_doc = pit_bd_ficha_pit.cod_tipo_doc_taz AND org_ficha_taz.n_documento = pit_bd_ficha_pit.n_documento_taz
	 INNER JOIN clar_bd_jurado_evento_clar ON clar_bd_jurado_evento_clar.cod_jurado = clar_calif_ficha_pit_clar_2.cod_jurado
...
ORDER BY organizacion ASC";
	...
	?>
		<tr>
			...
			<td><a href="gestor_calif_pit.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&cod=<? echo $fila['cod_ficha_calif_pit'];?>&action=DELETE&modo=SEGUNDO_CLAR" class="small alert button">Eliminar</a></td>
		</tr>
	<?
	}
	?>	
