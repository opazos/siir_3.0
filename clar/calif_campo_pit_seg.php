...
<form name="form5" method="post" action="gestor_calif_pit.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&action=ADD&modo=SEGUNDO_CAMPO" onsubmit="return checkSubmit();">
...
<div class="twelve columns"><hr/></div>
      ...
      <thead>
        ...
        <tr>
          <td rowspan="5">I.- Capacidad Organizacional</td>
...
<table>
	...
	<?
	$num=0;
	$sql="SELECT clar_calif_ficha_pit_2.total_puntaje, 
	org_ficha_taz.n_documento, 
	org_ficha_taz.nombre AS organizacion, 
	clar_bd_miembro.nombre, 
	clar_bd_miembro.paterno, 
	clar_bd_miembro.materno, 
	clar_calif_ficha_pit_2.cod_ficha_calif_pit
FROM clar_bd_ficha_pit_2 INNER JOIN clar_calif_ficha_pit_2 ON clar_bd_ficha_pit_2.cod_ficha_pit_clar = clar_calif_ficha_pit_2.cod_ficha_pit_clar
	 INNER JOIN clar_bd_jurado_evento_clar ON clar_bd_jurado_evento_clar.cod_jurado = clar_calif_ficha_pit_2.cod_jurado
...
ORDER BY organizacion ASC";
	...
	?>
		<tr>
			...
			<td><a href="gestor_calif_pit.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&cod=<? echo $fila['cod_ficha_calif_pit'];?>&action=DELETE&modo=SEGUNDO_CAMPO" class="small alert button">Eliminar</a></td>
		</tr>
	<?
	}
	?>	
