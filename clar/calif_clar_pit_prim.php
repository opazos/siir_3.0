...
<form name="form5" method="post" action="gestor_calif_pit.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&action=ADD&modo=PRIMERO_CLAR" onsubmit="return checkSubmit();">
...
<table>
        ...
        <tr>
          <td rowspan="5">Presentación pública en CLAR del PIT</td>
          <td rowspan="2">1.1 Mapa Cultural</td>
          <td>La coherencia de las iniciativas con las poetencialidades y perspectivas del desarrollo del territorio</td>
          <td align="center"><input name="p1" type="text" class="required number mini" /></td>
        </tr>
        <tr>
          <td>Evidencia de construcción colectiva del Mapa Cultural del PIT</td>
          <td align="center"><input name="p2" type="text" class="required number mini" /></td>
        </tr>
        <tr>
          <td>1.2 Claridad</td>
          <td>Evalúa la claridad en la presentación del PIT</td>
        ...
        <tr>
          <td>1.4 Participacion de los representantes del PIT</td>
          ...
          <td align="center"><input name="p5" type="text" class="required number mini" /></td>
        </tr>
      </table>
...
<table>
	...
	<?
	$num=0;
	$sql="SELECT clar_calif_ficha_pit_clar.total_puntaje, 
	org_ficha_taz.n_documento, 
	org_ficha_taz.nombre AS organizacion, 
	clar_bd_miembro.nombre, 
	clar_bd_miembro.paterno, 
	clar_bd_miembro.materno, 
	clar_calif_ficha_pit_clar.cod_ficha_calif_pit
	FROM clar_bd_ficha_pit INNER JOIN clar_calif_ficha_pit_clar ON clar_bd_ficha_pit.cod_ficha_pit_clar = clar_calif_ficha_pit_clar.cod_ficha_pit_clar
	 INNER JOIN clar_bd_jurado_evento_clar ON clar_bd_jurado_evento_clar.cod_jurado = clar_calif_ficha_pit_clar.cod_jurado
	...
	?>
		<tr>
			...
			<td><a href="gestor_calif_pit.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $anio;?>&cod=<? echo $fila['cod_ficha_calif_pit'];?>&action=DELETE&modo=PRIMERO_CLAR" class="small alert button">Eliminar</a></td>
		</tr>
	<?
	}
	?>	
