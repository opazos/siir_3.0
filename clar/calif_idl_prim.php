...
<form name="form5" method="post" action="gestor_calif_idl.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&action=ADD&modo=PRIMERO_CLAR" onsubmit="return checkSubmit();">
...
<table>
        ...
        <tr>
          <td>3.4 La población esta comprometida con el proyecto </td>
...
<table>
	...
	<?
	$num=0;
	$sql="SELECT clar_calif_ficha_idl_clar.total_puntaje, 
	...
	clar_bd_miembro.paterno, 
	clar_bd_miembro.materno, 
	clar_calif_ficha_idl_clar.cod_ficha_calif_idl
FROM clar_bd_ficha_idl INNER JOIN clar_calif_ficha_idl_clar ON clar_bd_ficha_idl.cod_ficha_idl_clar = clar_calif_ficha_idl_clar.cod_ficha_idl_clar
	 INNER JOIN clar_bd_jurado_evento_clar ON clar_bd_jurado_evento_clar.cod_jurado = clar_calif_ficha_idl_clar.cod_jurado
	 ...
	 INNER JOIN pit_bd_ficha_idl ON pit_bd_ficha_idl.cod_ficha_idl = clar_bd_ficha_idl.cod_idl
	 INNER JOIN org_ficha_organizacion ON org_ficha_organizacion.cod_tipo_doc = pit_bd_ficha_idl.cod_tipo_doc_org AND org_ficha_organizacion.n_documento = pit_bd_ficha_idl.n_documento_org
WHERE clar_bd_ficha_idl.cod_clar='$id'
