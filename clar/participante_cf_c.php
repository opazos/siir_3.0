...
<!-- Contenedores -->
<dl class="tabs">
<dd  class="active"><a href="">Concursos finales - Iniciativas participantes - Categoria C</a></dd>
</dl>
<!-- Termino contenedores -->
<ul class="tabs-content">
<li class="active" id="simple1Tab">
<div class="row collapse">
<form name="form5" method="post" class="custom" action="gestor_cf.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&action=ADD_CAT_C" onsubmit="return checkSubmit();">
...
<div class="row">
  <div class="twelve columns"><h6>II.- Participantes - Categoria C</h6></div>

  <div class="twelve columns">Seleccionar Plan de Negocios</div> 
  <div class="twelve columns">
    <select name="pdn" class="large">
      <option value="" selected="selected">Seleccionar</option>
      <?php
      if($r1['cod_nivel']==1)
      {           
        ...
        WHERE org_ficha_organizacion.cod_dependencia='".$r1['cod_dependencia']."' AND
        ...
        ORDER BY org_ficha_organizacion.cod_dependencia ASC, pit_bd_ficha_pdn.f_contrato ASC, pit_bd_ficha_pdn.n_contrato ASC, org_ficha_organizacion.nombre ASC";
      }
      else
      {
        $sql="SELECT pit_bd_ficha_pdn.cod_pdn, 
        ...
        {
       ?>
        <option value="<?php echo $f1['cod_pdn'];?>"><? echo numeracion($f1['n_contrato'])."-".periodo($f1['f_contrato'])."-".$f1['oficina']." / ".$f1['nombre'];?></option>
       <?   
        }
      ?>
    </select>
...
<div class="row">
  <div class="twelve columns"><h6>III.- Participantes registrados - Categoria C</h6></div>
  <table>
    <thead>
      <tr>
        <th>N.</th>
    ...
    ?>
      <tr>
        ...
        <td><a href="gestor_cf.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&id=<? echo $f2['cod_participante'];?>&action=DELETE_CAT_C" class="tiny alert button">Desvincular</a></td>
      </tr>
    <?
    }
    ?>  
