...
<!-- Contenedores -->
<dl class="tabs">
<dd  class="active"><a href="">Concursos finales - Iniciativas participantes - Categoria A</a></dd>
</dl>
<!-- Termino contenedores -->
<ul class="tabs-content">
<li class="active" id="simple1Tab">
<div class="row collapse">
<form name="form5" method="post" class="custom" action="gestor_cf.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&action=ADD_CAT_A" onsubmit="return checkSubmit();">
...
<div class="row">
  <div class="twelve columns"><h6>II.- Participantes - Categoria A</h6></div>
...
<div class="row">
  <div class="twelve columns"><h6>III.- Participantes registrados - Categoria A</h6></div>
  <table>
    <thead>
      <tr>
        <th>N.</th>
    ...
    ?>
      <tr>
        ...
        <td><a href="gestor_cf.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&id=<? echo $f2['cod_participante'];?>&action=DELETE_CAT_A" class="tiny alert button">Desvincular</a></td>
      </tr>
    <?
    }
    ?>  
  ...
  <div class="twelve columns">
    <a href="participante_cf_b.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>" class="button success">Siguiente >></a>
