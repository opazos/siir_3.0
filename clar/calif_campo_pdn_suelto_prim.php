...
<form name="form5" method="post" action="gestor_calif_pdn_suelto.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&action=ADD&modo=PRIMERO_CAMPO" onsubmit="return checkSubmit();">
...
<table>
	...
	<?
	$num=0;
	$sql="SELECT clar_calif_ficha_pdn_suelto.total_puntaje, 
	pit_bd_ficha_pdn.denominacion, 
	...
	clar_bd_miembro.paterno, 
	clar_bd_miembro.materno, 
	clar_calif_ficha_pdn_suelto.cod_ficha_calif_pdn
FROM clar_bd_ficha_pdn_suelto INNER JOIN clar_calif_ficha_pdn_suelto ON clar_bd_ficha_pdn_suelto.cod_ficha_pdn_clar = clar_calif_ficha_pdn_suelto.cod_ficha_pdn_clar
	 INNER JOIN clar_bd_jurado_evento_clar ON clar_bd_jurado_evento_clar.cod_jurado = clar_calif_ficha_pdn_suelto.cod_jurado
