...
<div class="panel">
<div class="row">
<form name="form5" class="custom" method="post" action="gestor_calif_gastro.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&action=ADD" onsubmit="return checkSubmit();">
...
<table>
	...
	<tbody>
		...
		<tr>
			<td>Presentacion de (los) participante (s) y capacidad para explicar el origen, ingredientes y forma de preparación</td>
...
<div class="twelve columns">
	...
	<a href="calif_gastro.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=califica" class="secondary button">Finalizar</a>
</div>
...
<table>
	...
	<?
	$num=0;
	$sql="SELECT gcac_ficha_comida.cod_ficha, 
	gcac_ficha_comida.p_total, 
	gcac_participante_concurso.descripcion, 
	org_ficha_organizacion.nombre, 
	gcac_jurado_concurso.nombres, 
	gcac_jurado_concurso.apellidos
FROM gcac_participante_concurso INNER JOIN gcac_ficha_comida ON gcac_participante_concurso.cod_participante = gcac_ficha_comida.cod_participante
	 INNER JOIN gcac_jurado_concurso ON gcac_jurado_concurso.cod_jurado = gcac_ficha_comida.cod_jurado
...
WHERE gcac_participante_concurso.cod_concurso='$cod'";
	...
	?>
		<tr>
			...
			<td><a href="gestor_calif_gastro.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&id=<? echo $fila['cod_ficha'];?>&action=DELETE" class="small alert button">Eliminar</a></td>
		</tr>
	<?
	}
	?>	
