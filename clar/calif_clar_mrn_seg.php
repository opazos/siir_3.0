...
<form name="form5" method="post" action="gestor_calif_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&action=ADD&modo=SEGUNDO_CLAR" onsubmit="return checkSubmit();">
...
<thead>
        ...
        <tr>
          <td rowspan="6">Presentación del PGRN</td>
...
<table>
	...
	<?
	$num=0;
	$sql="SELECT clar_calif_ficha_mrn_clar_2.cod_ficha_calif_mrn, 
	clar_calif_ficha_mrn_clar_2.total_puntaje, 
	org_ficha_organizacion.n_documento, 
...
FROM clar_bd_ficha_mrn_2 INNER JOIN clar_calif_ficha_mrn_clar_2 ON clar_bd_ficha_mrn_2.cod_ficha_mrn_clar = clar_calif_ficha_mrn_clar_2.cod_ficha_mrn_clar
	 INNER JOIN clar_bd_jurado_evento_clar ON clar_bd_jurado_evento_clar.cod_jurado = clar_calif_ficha_mrn_clar_2.cod_jurado
...
ORDER BY organizacion ASC";
	...
	?>
		<tr>
			...
			<td><a href="gestor_calif_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&cod=<? echo $fila['cod_ficha_calif_mrn'];?>&action=DELETE&modo=SEGUNDO_CLAR" class="small alert button">Eliminar</a></td>
		</tr>
	<?
	}
	?>	
