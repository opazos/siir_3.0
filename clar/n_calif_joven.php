...
<div class="panel">
<div class="row">
<form name="form5" class="custom" method="post" action="gestor_calif_joven.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&action=ADD" onsubmit="return checkSubmit();">
...
<table>
	...
	<tbody>
		...
		<tr>
			<td>Muestra los aprendizajes adquiridos y la puesta en práctica  del “Territorio de Aprendizaje: Formación de Gerentes de Pequeñas Empresas Campesinas y Rurales” en Belén de Umbría en Colombia en su iniciativa.<br/>
Experiencias  de desarrollo organizacional, sistema financiero (sostenibilidad de la asociación).</td>
...
<div class="twelve columns">
	...
	<a href="calif_joven.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=califica" class="secondary button">Finalizar</a>
</div>
...
<table>
	...
	<?
	$num=0;
	$sql="SELECT gcac_ficha_jovenes.p_total, 
	gcac_jurado_concurso.nombres, 
	gcac_jurado_concurso.apellidos, 
	gcac_participante_concurso.descripcion, 
	gcac_ficha_jovenes.cod_ficha, 
	org_ficha_organizacion.nombre
FROM gcac_jurado_concurso INNER JOIN gcac_ficha_jovenes ON gcac_jurado_concurso.cod_jurado = gcac_ficha_jovenes.cod_jurado
	 INNER JOIN gcac_participante_concurso ON gcac_participante_concurso.cod_participante = gcac_ficha_jovenes.cod_participante
...
WHERE gcac_participante_concurso.cod_concurso='$cod'";
	...
	?>
		<tr>
			...
			<td><a href="gestor_calif_joven.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&id=<? echo $fila['cod_ficha'];?>&action=DELETE" class="small alert button">Eliminar</a></td>
		</tr>
	<?
	}
	?>	
