...
<form name="form5" method="post" action="gestor_calif_pdn_suelto.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&action=ADD&modo=PRIMERO_CLAR" onsubmit="return checkSubmit();">
...
<table>
	...
	clar_calif_ficha_pdn_clar_suelto.total_puntaje, 
	clar_bd_miembro.nombre, 
	clar_bd_miembro.paterno, 
	clar_bd_miembro.materno
FROM pit_bd_ficha_pdn INNER JOIN clar_bd_ficha_pdn_suelto ON pit_bd_ficha_pdn.cod_pdn = clar_bd_ficha_pdn_suelto.cod_pdn
	 INNER JOIN clar_calif_ficha_pdn_clar_suelto ON clar_calif_ficha_pdn_clar_suelto.cod_ficha_pdn_clar = clar_bd_ficha_pdn_suelto.cod_ficha_pdn_clar
	 INNER JOIN clar_bd_jurado_evento_clar ON clar_bd_jurado_evento_clar.cod_jurado = clar_calif_ficha_pdn_clar_suelto.cod_jurado
