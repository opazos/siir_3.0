...
if ($action==ADD)
{
	...
	$sql="INSERT INTO gcac_ficha_mapa VALUES('','".$_POST['participante']."','".$_POST['p1']."','".$_POST['p2']."','".$_POST['p3']."','".$_POST['p4']."','$total_puntaje','".$_POST['jurado']."')";
	$result=mysql_query($sql) or die (mysql_error());
	
	//2.- Realizo promedios
	$sql="SELECT AVG(gcac_ficha_mapa.p_total) AS promedio
	FROM gcac_ficha_mapa
	WHERE gcac_ficha_mapa.cod_participante='".$_POST['participante']."'";
	$result=mysql_query($sql) or die (mysql_error());
