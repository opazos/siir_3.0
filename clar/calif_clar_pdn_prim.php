...
<form name="form5" method="post" action="gestor_calif_pdn_clar.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&action=ADD&modo=PRIMERO_CLAR" onsubmit="return checkSubmit();">
...
<div class="twelve columns"><hr/></div>
      ...
      <thead>
        ...
        <tr>
          <td rowspan="5">Presentación del PDN</td>
        ...
        <tr>
          <td>1.2.- Claridad</td>
          <td>Evalúa la claridad en la presentación del PDN, utilizando los medios que son accesibles o ingeniados por el grupo (fotos, mapas, productos, sociodrama, etc.) </td>
        ...
        <tr>
          ...
          <td>Evalua el nivel de participación de los socios de la organización, mujeres, jovenes y niños en la presentación del PDN</td>
...
<table>
	...
	<?
	$num=0;
	$sql="SELECT clar_calif_ficha_pdn_clar.cod_ficha_calif_pdn, 
	clar_calif_ficha_pdn_clar.total_puntaje, 
	pit_bd_ficha_pdn.denominacion, 
	org_ficha_organizacion.n_documento, 
...
FROM clar_bd_ficha_pdn INNER JOIN clar_calif_ficha_pdn_clar ON clar_bd_ficha_pdn.cod_ficha_pdn_clar = clar_calif_ficha_pdn_clar.cod_ficha_pdn_clar
	 INNER JOIN clar_bd_jurado_evento_clar ON clar_calif_ficha_pdn_clar.cod_jurado = clar_bd_jurado_evento_clar.cod_jurado
...
ORDER BY org_ficha_organizacion.nombre ASC";
	...
	?>
		<tr>
			...
			<td><a href="gestor_calif_pdn_clar.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&cod=<? echo $fila['cod_ficha_calif_pdn'];?>&action=DELETE&modo=PRIMERO_CLAR" class="small alert button">Eliminar</a></td>
		</tr>
	<?
	}
	?>	
