...
<!-- Iniciamos el contenido -->
    ...
    <div class="row">
	    ...
	    <div class="twelve columns" align="center"><h5>RELACION DE PARTICIPANTES DEL PLAN DE GESTIÓN DE RECURSOS NATURALES</h5></div>
...
{
?>
<a href="../seguimiento/mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime_familia" class="button secondary oculto">Retornar al menu principal</a>
<?
}
else
{
?>
<a href="../pit/mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime_familia" class="button secondary oculto">Retornar al menu principal</a>
<?
}
?>
