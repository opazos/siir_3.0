...
//Busco el pit de la ampliacion
$sql="SELECT clar_ampliacion_pit.f_ampliacion
FROM pit_bd_ficha_pdn INNER JOIN clar_atf_pdn ON clar_atf_pdn.cod_pdn = pit_bd_ficha_pdn.cod_pdn
...
elseif($row2['f_contrato']=='0000-00-00')
{
$f_inicio=$row3['f_ampliacion'];
}
else
{
...
<table width="90%" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <td width="29%"><? echo fecha_normal($f_inicio);?></td>
    <td width="23%">Fecha de termino</td>
    <td width="27%">
    <?
     		$fecha_1 = $f_inicio;
			$mes= $row['mes'];
			$nuevafecha = strtotime ( "+ ".$mes." month" , strtotime ( $fecha_1 ) ) ;
...
$sql="SELECT pit_bd_at_pdn.rubro, 
  ...
  pit_bd_at_pdn.n_mes, 
  (pit_bd_at_pdn.aporte_pdss+pit_bd_at_pdn.aporte_org) AS aporte_total, 
...
<table width="90%" border="1" align="center" cellpadding="2" cellspacing="2" class="mini">
  <tr class="txt_titulo">
    ...
    <td rowspan="2">ESPECIALISTA SOLICITADO</td>
    <td colspan="3" class="centrado">MONTO EJECUTADO (S/.)</td>
  </tr>
  <tr class="txt_titulo centrado">
    <td>SS II</td>
    <td>Socios</td>
...
<br/>
<div class="capa txt_titulo">5.3.- Manejo de costos de producción</div>
<br/>
<?
$num=0;
...
<table width="90%" border="1" cellspacing="1" cellpadding="1" align="center">
  ...
  <tr class="txt_titulo">
    ...
    <td>Costo de inversión antes del PDN</td>
    <td>Costo de inversión con el PDN</td>
  </tr>
