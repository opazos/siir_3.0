...
{
?>
	<li><strong><? echo $f3['puesto'];?> Lugar</strong>: <? echo $f3['nombre'];?> con <? echo number_format($f3['puntaje'],2);?> puntos, a quien le corresponde un incentivo de S/. <? echo number_format($f3['premio'],2);?> (<? echo vuelveletra($f3['premio']);?>)</li>
<?
}
?>	
</ul>
