...
<!-- Iniciamos el contenido -->
    ...
    <div class="row">
	    ...
	    <div class="twelve columns" align="center"><h5>RELACION DE PARTICIPANTES DEL PLAN DE NEGOCIO</h5></div>
...
WHERE pit_bd_ficha_pdn.cod_pdn='$cod' AND
pit_bd_user_iniciativa.momento=1
ORDER BY org_ficha_usuario.titular DESC,
...
{
?>
<a href="../seguimiento/pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime_familia" class="button secondary oculto">Retornar al menu principal</a>
<?
}
else
{
?>
<a href="../pit/pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime_familia" class="button secondary oculto">Retornar al menu principal</a>
<?
}
?>
