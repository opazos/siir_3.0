...
<!-- Iniciamos el contenido -->
    ...
    <div class="row">
	    ...
	    <div class="twelve columns" align="center"><h5>RELACION DE PARTICIPANTES DEL PLAN DE NEGOCIO - SEGUNDO DESEMBOLSO</h5></div>
	    <div class="twelve columns"><h6>Nombre de la Organizacion del Plan de Negocio</h6></div>
	    <div class="twelve columns"><? echo $row['nombre'];?></div>
	    <div class="twelve columns"><br/></div>
	    <div class="twelve columns"><h6>Denominación del Plan de Negocio</h6></div>
	    <div class="twelve columns"><? echo $row['denominacion'];?></div>	    
...
WHERE pit_bd_ficha_pdn.cod_pdn='$cod'
ORDER BY org_ficha_usuario.titular DESC, org_ficha_usuario.nombre ASC, pit_bd_user_iniciativa.momento ASC, pit_bd_user_iniciativa.estado ASC";
			$result=mysql_query($sql) or die (mysql_error());
...
{
?>
<a href="../seguimiento/pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime_familia_segundo" class="button secondary oculto">Retornar al menu principal</a>
<?
}
else
{
?>
<a href="../pit/pdn_seg.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=imprime_familia" class="button secondary oculto">Retornar al menu principal</a>
<?
}
?>
</form>
