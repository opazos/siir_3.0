    ...
    <div class="twelve columns">
      <div class="panel">
        ...
        <div class="twelve columns">
	       ...
	       <form name="form5" class="custom" method="post" action="gestor_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=UPDATE_ESTADO">
...
?>			        
	        ...
	        <div class="twelve columns">
		        ...
		        <a href="pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit" class="secondary button">Finalizar</a>
	        </div>
