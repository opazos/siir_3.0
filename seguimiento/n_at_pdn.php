...
$total=mysql_num_rows($result1);
	...
	if ($total==0)
	{
		...
		if ($total1==0)
		{
			...
			if ($total2==0)
			{
				echo "<script>window.location ='n_at_pdn.php?SES=$SES&anio=$anio&error=no_dni'</script>";
			}
			else
			{
...
<!-- Contenedores -->
<dl class="tabs">
<dd  class="active"><a href="">Registro de Asistentes Tecnicos</a></dd>
</dl>
<!-- Termino contenedores -->
<ul class="tabs-content">
<li class="active" id="simple1Tab">
<div class="row collapse">
<form name="form5" method="post" action="gestor_at_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
	

<div class="twelve columns"><h6>I.- Datos del asistente tecnico</h6></div>	
...
<button type="button" onclick="this.form.action='n_at_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=VERIFICAR';this.form.submit()" class="small success button">Verificar DNI</button>
</div>
...
<div class="four columns">
	<select name="sexo" class="required five">
...
<div class="four columns">
	<select name="tipo_oferente" class="required ten">
		<option value="" selected="selected">Seleccionar</option>
		<?
		if ($externo==1)
		{
...
<div class="twelve columns"><h6>II.- Informacion de la asistencia tecnica</h6></div>
	<div class="twelve columns">Seleccionar el Plan de Negocios</div>
	<div class="twelve columns">
...
<div class="two columns">Tema de la asistencia tecnica</div>
...
<div class="four columns"><input type="text" name="varones" class="five required digits"></div>
<div class="two columns">Nº mujeres a los que brindo asistencia tecnica</div>
<div class="four columns"><input type="text" name="mujeres" class="five required digits"></div>

<div class="two columns">Calificacion de desempeño</div>
<div class="four columns">
	<select name="calificacion" class="required five">
		<option value="" selected="selected">Seleccionar</option>
		<?
...
<div class="four columns">
	<select name="asignacion" class="required five">
		<option value="" selected="selected">Seleccionar</option>
		<?
...
<div class="seven columns">
	<select name="estado" class="required five">
		<option value="" selected="selected">Seleccionar</option>
...
<div class="twelve columns">
	...
	<a href="at_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit" class="secondary button">Finalizar</a>
</div>
