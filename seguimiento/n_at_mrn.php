...
$total=mysql_num_rows($result1);
	...
	if ($total==0)
	{
		...
		if ($total1==0)
		{
			...
			if ($total2==0)
			{
				echo "<script>window.location ='n_at_mrn.php?SES=$SES&anio=$anio&error=no_dni'</script>";
			}
			else
			{
...
<form name="form5" method="post" action="gestor_at_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
...
<button type="button" onclick="this.form.action='n_at_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=VERIFICAR';this.form.submit()" class="small success button">Verificar DNI</button>
</div>
...
<div class="twelve columns">
	<select name="actividad" class="hyjack">
		<option value="" selected="selected">Seleccionar</option>
		<?
...
<div class="four columns">
	<select name="calificacion" class="seven required">
		<option value="" selected="selected">Seleccionar</option>
		<?
...
<div class="four columns">
	<select name="asignacion" class="seven required">
		<option value="" selected="selected">Seleccionar</option>
		<?
...
<div class="seven columns">
	<select name="estado" class="five required">
		<option value="" selected="selected">Seleccionar</option>
