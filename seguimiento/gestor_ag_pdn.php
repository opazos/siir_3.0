...
{
	echo "<script>window.location ='n_ag_pdn.php?SES=$SES&anio=$anio&error=vacio'</script>";
}
else
{
...
$sql="INSERT INTO ficha_aag VALUES('','008','".$_POST['dni']."','4','".$_POST['pdn']."','".$_POST['f_inicio']."','".$_POST['f_termino']."','".$_POST['aporte_pdss']."','".$_POST['aporte_org']."','".$_POST['aporte_otro']."',UPPER('".$_POST['resultado']."'),'".$_POST['asignacion']."','".$_POST['calificacion']."','".$_POST['estado']."')";
$result=mysql_query($sql) or die (mysql_error());


	//3.- Redireccionamos
echo "<script>window.location ='ag_pdn.php?SES=$SES&anio=$anio&modo=edit'</script>";	
}
}
