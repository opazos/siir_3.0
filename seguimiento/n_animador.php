...
<!-- Contenedores -->
<dl class="tabs">
<dd  class="active"><a href="">Registro de animador Territorial</a></dd>
</dl>
<!-- Termino contenedores -->
<ul class="tabs-content">
<li class="active" id="simple1Tab">
<div class="row collapse">
<form name="form5" class="custom" method="post" action="gestor_animador.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
	

<div class="twelve columns"><h6>I.- Datos del animador territorial</h6></div>	
...
<button type="button" onclick="this.form.action='n_animador.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=VERIFICAR';this.form.submit()" class="small success button">Verificar DNI</button>
</div>
