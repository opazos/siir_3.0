...
<form name="form5" class="custom" method="post" action="gestor_at_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=UPDATE" onsubmit="return checkSubmit();">
...
{
?>
<option value="<? echo $f1['cod_pdn'];?>" <? if ($f1['cod_pdn']==$row['cod_iniciativa'] and $row['cod_tipo_iniciativa']==004) echo "selected";?>><? echo $f1['nombre']."-".$f1['denominacion'];?></option>
<?
}
?>
		</select>
