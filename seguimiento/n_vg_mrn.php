...
<form name="form5" class="custom" method="post" action="gestor_vg_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&action=ADD_ASISTENTE" onsubmit="return checkSubmit();">
...
FROM org_ficha_usuario INNER JOIN pit_bd_user_iniciativa ON org_ficha_usuario.cod_tipo_doc = pit_bd_user_iniciativa.cod_tipo_doc AND org_ficha_usuario.n_documento = pit_bd_user_iniciativa.n_documento
	 INNER JOIN ficha_vg ON ficha_vg.cod_tipo_iniciativa = pit_bd_user_iniciativa.cod_tipo_iniciativa AND ficha_vg.cod_iniciativa = pit_bd_user_iniciativa.cod_iniciativa
	 INNER JOIN pit_bd_ficha_mrn ON pit_bd_ficha_mrn.cod_tipo_iniciativa = ficha_vg.cod_tipo_iniciativa AND pit_bd_ficha_mrn.cod_mrn = ficha_vg.cod_iniciativa AND pit_bd_ficha_mrn.cod_tipo_doc_org = org_ficha_usuario.cod_tipo_doc_org AND pit_bd_ficha_mrn.n_documento_org = org_ficha_usuario.n_documento_org
	 LEFT OUTER JOIN ficha_participante_vg ON ficha_participante_vg.cod_visita = ficha_vg.cod_visita AND ficha_participante_vg.cod_tipo_doc = pit_bd_user_iniciativa.cod_tipo_doc AND ficha_participante_vg.n_documento = pit_bd_user_iniciativa.n_documento
...
<div class="twelve columns">
	...
	<a href="vg_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit" class="secondary button">Finalizar</a>
</div>
...
{
?>
<form name="form5" class="custom" method="post" action="gestor_vg_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
