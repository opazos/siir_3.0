...
<form name="form5" class="custom" method="post" action="gestor_ag_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=UPDATE" onsubmit="return checkSubmit();">
...
{
?>
<option value="<? echo $f1['cod_mrn'];?>" <? if ($f1['cod_mrn']==$row['cod_iniciativa'] and $row['cod_tipo_iniciativa']==5) echo "selected";?>><? echo $f1['nombre']." ".$f1['sector'];?></option>
<?
}
?>
		</select>
