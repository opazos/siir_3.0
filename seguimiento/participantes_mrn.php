...
<!-- Contenedores -->
<dl class="tabs">
<dd  class="active"><a href="">Actualizacion de Participantes del PGRN: <? echo $r1['nombre']." - ".$r1['sector'];?></a></dd>
</dl>
<!-- Termino contenedores -->
<ul class="tabs-content">
<li class="active" id="simple1Tab">
<div class="row collapse">
<form name="form5" class="custom" method="post" action="gestor_participante_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&action=UPDATE" onsubmit="return checkSubmit();">
...
<div class="twelve columns">
	...
	<a href="mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=familia" class="secondary button">Finalizar</a>
</div>
