...
<!-- Contenedores -->
<dl class="tabs">
<dd  class="active"><a href="">Actualizacion de Junta Directiva Vigente del PGRN: <? echo $r1['nombre']." - ".$r1['sector'];?></a></dd>
</dl>
<!-- Termino contenedores -->
<ul class="tabs-content">
<li class="active" id="simple1Tab">
<div class="row collapse">
<form name="form5" class="custom" method="post" action="gestor_directiva_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $id;?>&action=UPDATE" onsubmit="return checkSubmit();">
	...
	<tr>
		...
		<td>
			<select name="nombre[]">
				...
				FROM pit_bd_ficha_mrn INNER JOIN org_ficha_usuario ON pit_bd_ficha_mrn.cod_tipo_doc_org = org_ficha_usuario.cod_tipo_doc_org AND pit_bd_ficha_mrn.n_documento_org = org_ficha_usuario.n_documento_org
				WHERE pit_bd_ficha_mrn.cod_mrn='$id'
...
$sql="SELECT org_ficha_directivo.cod_directivo, 
	...
	org_ficha_usuario.paterno, 
	org_ficha_usuario.materno
FROM org_ficha_directivo INNER JOIN sys_bd_cargo_directivo ON sys_bd_cargo_directivo.cod_cargo = org_ficha_directivo.cod_cargo
	 INNER JOIN org_ficha_usuario ON org_ficha_usuario.cod_tipo_doc = org_ficha_directivo.cod_tipo_doc AND org_ficha_usuario.n_documento = org_ficha_directivo.n_documento
	 INNER JOIN pit_bd_ficha_mrn ON org_ficha_usuario.cod_tipo_doc_org = pit_bd_ficha_mrn.cod_tipo_doc_org AND org_ficha_usuario.n_documento_org = pit_bd_ficha_mrn.n_documento_org AND org_ficha_directivo.cod_tipo_doc_org = pit_bd_ficha_mrn.cod_tipo_doc_org AND org_ficha_directivo.n_documento_org = pit_bd_ficha_mrn.n_documento_org
WHERE pit_bd_ficha_mrn.cod_mrn='$id'
...
<div class="twelve columns">
	...
	<a href="mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=directiva" class="secondary button">Finalizar</a>
