...
<div class="three panel columns">
 <ul class="nav-bar vertical">
  <li class="active"><a href="n_ag_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>">Registrar nuevo</a></li>
  <li><a href="ag_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit">Modificar informacion</a></li>
  <li><a href="ag_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=delete">Eliminar</a></li>
</ul> 
	        ...
	        <table class="responsive" id="lista">
		        <thead>
					...
					FROM sys_bd_califica INNER JOIN ficha_aag ON sys_bd_califica.cod = ficha_aag.cod_calificacion
					 ...
					 INNER JOIN pit_bd_ficha_mrn ON pit_bd_ficha_mrn.cod_mrn = ficha_aag.cod_iniciativa AND pit_bd_ficha_mrn.cod_tipo_iniciativa = ficha_aag.cod_tipo_iniciativa
			        ...
			        <tr>
				        ...
				        <td>
					        ...
					        {
					        ?>
					        <a href="m_ag_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_aag'];?>" class="small primary button">Editar</a>
					        <?
					        }
					        elseif($modo==delete)
					        {
					        ?>
					        <a href="gestor_ag_mrn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_aag'];?>&action=DELETE" classs="small alert button">Eliminar</a>
					        <?
					        }
					        ?>
				        </td>
