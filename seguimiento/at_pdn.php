...
<div class="three panel columns">
 <ul class="nav-bar vertical">
  <li class="active"><a href="n_at_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>">Registrar nuevo</a></li>
  <li><a href="at_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit">Modificar informacion</a></li>
  <li><a href="at_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=delete">Eliminar</a></li>
</ul> 
...
$num++
                ...
                <td><h5><small><? echo number_format($fila['monto'],2);?></small></h5></td>
				        ...
				        <td>
					        ...
					        {
					        ?>
					        <a href="m_at_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_sat'];?>" class="small primary button">Editar</a>
					        <?
					        }
					        elseif($modo==delete)
					        {
