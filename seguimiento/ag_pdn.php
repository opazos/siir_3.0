...
<div class="three panel columns">
 <ul class="nav-bar vertical">
  <li class="active"><a href="n_ag_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>">Registrar nuevo</a></li>
  <li><a href="ag_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit">Modificar informacion</a></li>
  <li><a href="ag_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=delete">Eliminar</a></li>
</ul> 
	        ...
	        <table class="responsive" id="lista">
		      <thead>
			        <tr>
				        ...
				        <th><h5><small>Nombres y apellidos completos</small></h5></th>
              ...
              ficha_aag.aporte_otro) AS monto
              FROM sys_bd_califica INNER JOIN ficha_aag ON sys_bd_califica.cod = ficha_aag.cod_calificacion
               ...
               INNER JOIN pit_bd_ficha_pdn ON pit_bd_ficha_pdn.cod_pdn = ficha_aag.cod_iniciativa AND pit_bd_ficha_pdn.cod_tipo_iniciativa = ficha_aag.cod_tipo_iniciativa
              ...
              $num++
			        ...
			        <tr>
				        ...
				        <td><h5><small><? echo $fila['organizacion']."-".$fila['denominacion'];?></small></h5></td>
                ...
                <td><h5><small><? echo number_format($fila['monto'],2);?></small></h5></td>
				        ...
				        <td>
					        ...
					        {
					        ?>
					        <a href="m_ag_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_aag'];?>" class="small primary button">Editar</a>
					        <?
					        }
					        elseif($modo==delete)
					        {
					        ?>
					        <a href="gestor_ag_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_aag'];?>&action=DELETE" class="small alert button">Eliminar</a>
					        <?
					        }
					        ?>
				        </td>
