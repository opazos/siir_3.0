...
<div class="three panel columns">
 <ul class="nav-bar vertical">
  <li class="active"><a href="n_vg_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>">Registrar visita</a></li>
  <li><a href="vg_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit">Modificar</a></li>
  <li><a href="vg_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=delete">Eliminar</a></li>
</ul>
...
?>
			        <tr>
				        ...
				        <td>
					        ...
					        {
						        ?>
						        <a href="m_vg_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_visita'];?>" class="small primary button">Editar</a>
						        <?
					        }
					        elseif($modo==delete)
					        {
					        ?>
					        <a href="gestor_vg_pdn.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&id=<? echo $fila['cod_visita'];?>&action=DELETE" class="small alert button">Eliminar</a>
					        <?
					        }
					        ?>
				        </td>	
