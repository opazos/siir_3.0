...
<form name="form5" method="post" action="gestor_ahorro.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&action=ADD" onsubmit="return checkSubmit();">
	...
	<div class="twelve columns"><h6>I.- Información del Grupo de Ahorro</h6></div>
	...
	<div class="ten columns"><input type="text" name="nombre" class="required nine"></div>
	<div class="twelve columns"><br/></div>
	<div class="twelve columns">
	<button type="submit" class="primary button">Guardar cambios</button>
	<a href="ahorro.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&modo=edit" class="secondary button">Cancelar</a></div>
