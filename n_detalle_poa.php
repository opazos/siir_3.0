...
<!-- Contenedores -->
<dl class="tabs">
<dd  class="active"><a href="">Añadir Información</a></dd>
</dl>
<!-- Termino contenedores -->
<ul class="tabs-content">
<li class="active" id="simple1Tab">
<div class="row collapse">
<form name="form5" class="custom" method="post" action="gestor_detalle_poa.php?SES=<? echo $SES;?>&anio=<? echo $anio;?>&cod=<? echo $cod;?>&action=ADD" onsubmit="return checkSubmit();">

<div class="two columns">Subactividad</div>
<div class="ten columns"><? echo $r1['codigo']." - ".$r1['nombre'];?></div>
<div class="two columns">Unidad de medida</div>
<div class="ten columns"><? echo $r1['unidad'];?></div>
<div class="twelve columns"><hr/></div>
	...
	<div class="four columns">
		<select name="oficina">
			...
			{
			?>
			<option value="<? echo $r1['cod_dependencia'];?>"><? echo $r1['nombre'];?></option>
			<?
			}
			?>
		</select>
	...
	<div class="ten columns"><input type="text" name="meta" class="required number two"></div>
	...
	<div class="four columns"><input type="text" name="donacion" class="required number seven"></div>
	
	<div class="twelve columns"><h6>Contrapartidas</h6></div>	
	<div class="two columns">Cofinanciadores (S/.)</div>
	<div class="ten columns"><input type="text" name="cofinanciador" class="required number two"></div>
	
	<div class="two columns">Usuarios (S/.)</div>
	<div class="ten columns"><input type="text" name="usuario" class="required number two"></div>	
